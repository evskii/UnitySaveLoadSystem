...
public class UsageExample : MonoBehaviour
{
    void Start() {
        ...
        List<SaveLoadSystem.DataBlock> myDataBlock = new List<SaveLoadSystem.DataBlock>();
        myDataBlock.Add(new SaveLoadSystem.DataBlock("Souls", 64));
        SaveLoadSystem.Save(myDataBlock.ToArray());
